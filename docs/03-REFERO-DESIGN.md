# 03 · Refero Design (Referencia externa)

> ⚠️ **Advertencia**
>
> Este documento contiene un sistema de diseño externo descargado desde Refero.
> Debe utilizarse únicamente como referencia de jerarquía, espaciado, proporciones,
> componentes, ritmo visual e interacciones. **No debe copiarse literalmente.**
> La identidad definida en [`02-BRAND.md`](02-BRAND.md) siempre tiene prioridad.

## Cómo usar esta referencia

-   ✅ Sí: estudiar estructura, jerarquía, escalas de espaciado, ritmo y patrones de interacción.
-   ❌ No: copiar colores, tipografías, textos o componentes tal cual.
-   Cada decisión que se adopte debe registrarse en [`07-DESIGN-DECISIONS.md`](07-DESIGN-DECISIONS.md).

---

## Contenido descargado desde Refero

<!-- INICIO CONTENIDO REFERO -->
